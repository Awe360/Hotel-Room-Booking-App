  ...
  <div className="w-full">
    ...
    <div className="flex flex-col justify-center items-center text-gray-600">
      ...
      ></iframe>
          ...
          {/* Tabs */}
          <div className="border-b border-gray-300 mb-6 flex justify-between">
            ...
            <Link className="bg-green-500 p-3 mr-36 rounded-lg text-white font-bold" to={`/admin/hotels/newRoom/${hotelId}`} >+ Add Room</Link>
          </div>
